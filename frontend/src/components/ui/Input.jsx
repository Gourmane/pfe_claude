  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        className={[
          'min-h-11 w-full rounded-[10px] border border-navy-200 bg-white px-3.5 text-[13px] leading-6 text-navy-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.92)] outline-none transition-[border-color,box-shadow,background-color] placeholder:text-navy-300 disabled:cursor-not-allowed disabled:border-navy-100 disabled:bg-surface-section/70 disabled:text-navy-400 disabled:placeholder:text-navy-300',
          error
