          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-bold uppercase tracking-widest text-primary-light opacity-70">
                  Admin
                </span>
            ...
            <p className="mt-4 text-sm leading-relaxed text-navy-400">
              Supervision des clients, des tickets et des affectations.
            </p>
          </div>
        ...
        <header className="sticky top-0 z-10 bg-surface-content/90 backdrop-blur-md px-6 py-4 lg:px-10">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="rounded-xl bg-surface-container-lowest px-4 py-2 flex items-center gap-2 shadow-[0_1px_3px_rgba(15,42,68,0.06)]">
              <div className="h-2 w-2 rounded-full bg-[#0F2A44] shadow-[0_0_8px_rgba(15,42,68,0.4)]"></div>
              <p className="text-xs font-bold tracking-wide text-navy-800">ADMIN</p>
            </div>
          </div>
        </header>
